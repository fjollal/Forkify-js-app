...
})({"4H8QY":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 55985;
...
const controlSearchResults = async function() {
    ...
    if (!query) {
        (0, _resultsViewJsDefault.default).renderMessage('Please type a recipe name or ingredient.');
        return;
    }
    try {
        ...
        const firstId = _modelJs.state.search.results[0].id;
        await _modelJs.loadRecipe(firstId);
        _modelJs.setBookmarked();
        (0, _recipeViewJsDefault.default).render(_modelJs.state.recipe);
...
const controlAddBookmark = function() {
    if (!_modelJs.state.recipe.id) return;
    if (_modelJs.state.bookmarks.some((b)=>b.id === _modelJs.state.recipe.id)) _modelJs.deleteBookmark(_modelJs.state.recipe.id);
...
const controlAddRecipe = async function() {
    try {
        ...
        const newRecipe = (0, _addRecipeViewJsDefault.default).getRecipe();
        await _modelJs.uploadRecipe(newRecipe);
        (0, _addRecipeViewJsDefault.default).clearStatus();
...
const init = function() {
    ...
    (0, _addRecipeViewJsDefault.default).addHandlerOpenWindow();
    (0, _addRecipeViewJsDefault.default).addHandlerUpload(controlAddRecipe);
    _modelJs.initBookmarks();
    (0, _bookmarksViewJsDefault.default).render(_modelJs.state.bookmarks);
    (0, _resultsViewJsDefault.default).renderMessage();
};
init();
...
parcelHelpers.export(exports, "setBookmarked", ()=>setBookmarked);
...
const setBookmarked = function() {
    if (!state.recipe.id) return;
    state.recipe.bookmarked = state.bookmarks.some((b)=>b.id === state.recipe.id);
};
const uploadRecipe = async function(newRecipe) {
    if (!(0, _configJs.KEY)) throw new Error("Add your API key in src/js/config.js \u2014 get one free at https://forkify-api.jonas.io/v2");
    const data = await (0, _helpersJs.sendJSON)(`${(0, _configJs.API_URL)}?key=${(0, _configJs.KEY)}`, newRecipe);
    state.recipe = createRecipeObject(data);
...
// Get your free API key at: https://forkify-api.jonas.io/v2 (click "Generate your API key")
// Required only for uploading recipes. Search and viewing recipes work without it.
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _formatQuantityJs = require("../helpers/formatQuantity.js");
var _formatQuantityJsDefault = parcelHelpers.interopDefault(_formatQuantityJs);
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
      ...
      <div class="recipe__details">
        ...
        ${recipe.key ? `<div class="recipe__user-generated">
    ...
    _generateMarkupIngredient(ing) {
      ...
      <li class="recipe__ingredient">
        ...
        <div class="recipe__quantity">${(0, _formatQuantityJsDefault.default)(ing.quantity)}</div>
    ...
    update(data) {
        ...
        ingredients.forEach((ing, i)=>{
            el.querySelector(`.recipe__ingredient:nth-child(${i + 1}) .recipe__quantity`).textContent = (0, _formatQuantityJsDefault.default)(ing.quantity);
        });
    }
}
exports.default = new RecipeView();

},{"./view.js":"2kjY2","url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","../helpers/formatQuantity.js":"2y4Yt"}],"2kjY2":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
},{}],"2y4Yt":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>formatQuantity);
...
class PaginationView extends (0, _viewJsDefault.default) {
    _parentElementSelector = '.pagination';
...
class AddRecipeView {
    ...
    getRecipe() {
        ...
        const ingredients = dataArr.slice(6).map((ing)=>{
    ...
    renderSpinner() {
        this._clearStatus();
        this._window?.insertAdjacentHTML('beforeend', `
    ...
    _clearStatus() {
        this._window?.querySelectorAll('.upload-spinner, .upload-error, .upload-message').forEach((el)=>el.remove());
    }
}
...
},{}]},["4H8QY","7dWZ8"], "7dWZ8", "parcelRequire3a11", {}, "./", "/")

//# sourceMappingURL=Forkify-js-app.4a59a05f.js.map
